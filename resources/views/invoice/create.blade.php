					...
					<div class="toolbar" id="kt_toolbar">
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('bill') }}</h1>
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<li class="breadcrumb-item text-dark">{{ __('add_invoice') }}</li>
									</ul>
								</div>
												...
												<form action="" id="kt_invoice_form">
													<div class="d-flex flex-column align-items-start flex-xxl-row">
														<div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice date">
															<div class="fs-6 fw-bolder text-gray-700 text-nowrap">{{ __('date') }}:</div>
														...
														<div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Enter invoice number">
															<span class="fs-2x fw-bolder text-gray-800">{{ __('invoice') }} #</span>
														...
														<div class="d-flex align-items-center justify-content-end flex-equal order-3 fw-row" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Specify invoice due date">
															<div class="fs-6 fw-bolder text-gray-700 text-nowrap">{{ __('due_date') }}:</div>
															<div class="position-relative d-flex align-items-center w-150px">
													...
													<div class="mb-0">
														<div class="row gx-10 mb-5">
															<div class="col-lg-6">
																<label class="form-label fs-6 fw-bolder text-gray-700 mb-3">{{ __('invoice_detail') }}</label>
																<div class="mb-5">
														...
														<div class="mb-0">
															<label class="form-label fs-6 fw-bolder text-gray-700">{{ __('note')}}</label>
									...
									<div class="flex-lg-auto min-w-lg-300px">
										<div class="card" data-kt-sticky="true" data-kt-sticky-name="invoice" data-kt-sticky-offset="{default: false, lg: '200px'}" data-kt-sticky-width="{lg: '250px', lg: '300px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
											<div class="card-body p-10">
												<div class="mb-10">
													<label class="form-label fw-bolder fs-6 text-gray-700">{{ __('search_payer')}}</label>
													<input type="text" name="" class="form-select form-select-solid" placeholder="{{ __('search_payer')}}">
												</div>
												...
												<div class="mb-0">
													<div class="row mb-5">
														<div class="col">
															<a href="#" class="btn btn-light btn-active-light-success w-100">{{ __('search') }}</a>
														</div>
														<div class="col">
															<a href="#" class="btn btn-light btn-active-light-danger w-100">{{ __('clear') }}</a>
														</div>
													</div>
