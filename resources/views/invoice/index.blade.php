						...
						<div class="toolbar" id="kt_toolbar">
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('bills') }}</h1>
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												<div class="w-150px me-3">
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Status" data-kt-ecommerce-order-filter="status">
														...
														<option value="DRAFT">SUCCESS</option>
													</select>
												</div>
												<!-- <button type="button" class="btn btn-success">Prepare Invoice</button> -->
												<a href="{{ url('/invoice/create') }}">
												    <button class="btn btn-success">{{ __('prepare_invoice') }}</button>
												</a>
											</div>
											<div class="d-flex justify-content-end align-items-center d-none" data-kt-customer-table-toolbar="selected">
												<div class="fw-bolder me-5">
												<span class="me-2" data-kt-customer-table-select="selected_count"></span>{{ __('selected') }}</div>
												<button type="button" class="btn btn-danger" data-kt-customer-table-select="delete_selected">{{ __('delete_selected') }}</button>
											</div>
										</div>
									</div>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															<div class="menu-item px-3">
																<a href="/invoice/show" class="menu-link px-3">View</a>
															</div>
															<div class="menu-item px-3">
																<a href="/invoice/edit" class="menu-link px-3">Edit</a>
															</div>
															<div class="menu-item px-3">
																<a href="/invoice" class="menu-link px-3">Validate</a>
															</div>
															<div class="menu-item px-3">
																<a href="/invoice" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Delete</a>
															</div>
														</div>
													</td>
												</tr>													
