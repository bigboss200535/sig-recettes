									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										<div class="menu-item">
											<a class="menu-link" href="{{ url('/payer/create') }}">
												...
												<span class="menu-title">{{ __('add_tax_payer') }}</span>
											</a>
										...
										<div class="menu-item">
											<a class="menu-link" href="{{ url('/payer/taxables') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
...
<!-- 										<div class="menu-item">
											<a class="menu-link" href="{{ url('/details') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">{{ __('Details') }}</span>
											</a>
										</div> -->
									</div>
								</div>
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										<div class="menu-item">
											<a class="menu-link" href="{{ url('/invoice') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
										...
										<div class="menu-item">
											<a class="menu-link" href="{{ url('/invoice/returns') }}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
										...
										<div class="menu-item">
													<a class="menu-link" href="{{ url('/invoice/approved') }}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">{{ __('approved') }}</span>
													</a>
											</div>
									</div>
								</div>
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										<div class="menu-item">
											<a class="menu-link" href="#">
												...
												<span class="menu-title">{{ __('general_report') }}</span>
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="#">
												...
												<span class="menu-title">{{ __('admin_report') }}</span>
											</a>
										</div>
										<div class="menu-item">
													<a class="menu-link" href="#">
														...
														<span class="menu-title">{{ __('other_report') }}</span>
													</a>
												</div>
									</div>
								</div>
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										<div class="menu-item">
											<a class="menu-link" href="/Users">
												...
												<span class="menu-title">{{ __('system_users') }}</span>
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="#">
